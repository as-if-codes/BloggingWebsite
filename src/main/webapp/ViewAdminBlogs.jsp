...
<head><%@ include file="Adminheader.jsp"%>
</head>
<style>
body {
	margin: 0;
...
if (!resultSet.isBeforeFirst()) {
   ...
   while (resultSet.next()) {
      ...
      out.println("<td><a href='AdminBlogView.jsp?blog_id=" + blogId + "'>" + "Read" + "</a></td>");
      out.println("<td><a href='UpdateBlogAdmin.jsp?blog_id=" + blogId + "'>" + "Update" + "</a></td>");
      out.println("<td><a href='deleteblog.jsp?blog_id=" + blogId + "'>" + "Delete" + "</a></td>");
      out.println("</tr>");
   }
   out.println("</table>");
}
